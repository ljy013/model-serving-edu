...
def covid_classifier_model2(img_path, filename):
    ...
    HEADERS = {'content-type': 'application/json', 'Host': 'head-base-covid.myspace.example.com    '}
    #MODEL2_API_URL = 'http://127.0.0.1:8511/v1/models/covid19/versions/1:predict'
    MODEL2_API_URL = 'http://35.204.251.121:32380/v1/models/head-base-covid:predict'
